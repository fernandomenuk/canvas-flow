...
await esbuild.build({
  entryPoints: ["bin/canvas-flow.js"],
  ...
  target: "node22",
  define: {
    "process.env.CANVAS_FLOW_BUILD_UMAMI_HOST": JSON.stringify(process.env.CANVAS_FLOW_UMAMI_HOST || ""),
    "process.env.CANVAS_FLOW_BUILD_UMAMI_WEBSITE_ID": JSON.stringify(process.env.CANVAS_FLOW_UMAMI_WEBSITE_ID || ""),
    "process.env.CANVAS_FLOW_BUILD_VERSION": JSON.stringify(packageJson.version),
  },
});
